			...
			<div className={`${boxWidth} ${flexCenter} w-full h-full`}>
				<div className='relative w-full h-full'>
					...
					<div className='flex flex-col justify-between items-center gap-8 z-[-1]'>
						...
						<div>
							<h1 className='text-white w-[320px] whitespace-break-spaces font-DMSans text-[45px] text-center leading-[55px] font-[800] sm:w-[70vw] md:text-[55px] lg:text-[65px] xl:text-[70px] md:leading-[70px] xl:w-[900px] tracking-tight xl:leading-[80px] overflow-hidden'>
